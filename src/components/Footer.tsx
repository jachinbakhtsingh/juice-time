  ...
  return (
    <footer className="bg-black text-white border-t border-neutral-800/80 select-none">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-20 pb-12">
        {/* Top Footer Section */}
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 pb-16 border-b border-neutral-800/60">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <span
                className="text-4xl sm:text-5xl font-black uppercase font-['Syne'] tracking-tighter"
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-neutral-800 hover:border-neutral-600 text-xs font-bold uppercase tracking-widest text-neutral-300 hover:text-white transition-all duration-200"
          >
        ...
        {/* Links & Newsletter */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-b border-neutral-800/60 text-xs">
          <div>
            <h4 className="font-bold uppercase tracking-wider text-neutral-300 mb-4 font-mono">
              Explore
            </h4>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-3 py-2 text-xs text-white placeholder-neutral-500 focus:outline-none focus:border-white/40"
              />
              <button
                type="button"
                className="px-3 py-2 bg-white text-black font-bold rounded-lg text-xs hover:bg-neutral-200 transition-colors uppercase tracking-wider"
              >
                Join
              </button>
            </div>
